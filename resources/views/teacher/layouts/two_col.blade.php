        ...
        <div class="container-fluid page-body-wrapper">
                    ...
                    <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
                        ...
                        <ul class="chat-list">
                            <li class="list active">
                                <div class="profile"><img src="{{asset('aseets/images/faces/face1.jpg')}}"
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    @if(Session::get('role')=='department_admin')
                    <p>Course</p>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/department-admin/add-course')}}">
                            <i class="icon-paper menu-icon"></i>
                            <span class="menu-title">Add Course</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/course/all')}}">
                            <i class="icon-paper menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/teacher/create-lesson-plan')}}">
                            <i class="icon-paper menu-icon"></i>
                            <span class="menu-title">Create Lesson Plan</span>
                        </a>
                    </li>
                    <!--  -->
                    @endif
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin/add-department') }}">
                            <i class="icon-grid menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin/department-admins') }}">
                            <i class="icon-head menu-icon"></i>
                            <span class="menu-title">Department Admins </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/admin/add-department-admin') }}">
                            <i class="icon-head menu-icon"></i>
                            <span class="menu-title">Add Department Admin </span>
                        </a>
                    </li>
                    @endif
                    ...
                    <p>Enrollment</p>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/student/enroll') }}">
                            <i class="icon-grid menu-icon"></i>
                            <span class="menu-title">Enroll </span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/student/enrollments') }}">
                            <i class="icon-grid menu-icon"></i>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{url('/teacher/my-courses')}}">
                            <i class="icon-paper menu-icon"></i>
